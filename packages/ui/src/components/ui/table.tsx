...
const Table = React.forwardRef<
  HTMLTableElement,
  React.HTMLAttributes<HTMLTableElement> & { children?: React.ReactNode; className?: string }
...
const TableHeader = React.forwardRef<
  ...
  React.HTMLAttributes<HTMLTableSectionElement> & { children?: React.ReactNode; className?: string }
>(({ className, children, ...props }, ref) => (
...
const TableCaption = React.forwardRef<
  ...
  React.HTMLAttributes<HTMLTableCaptionElement> & { children?: React.ReactNode; className?: string }
>(({ className, children, ...props }, ref) => (
